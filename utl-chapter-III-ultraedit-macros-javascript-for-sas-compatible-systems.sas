     ...
     III. List of enhanced functionality (full cheat sheet)  
          ...
          c. Javascript and User tools
          d. Macros 
          e. Templates 

     IV.  Miscelaneous 
     
          a.  Autosave all open files every minute                    
          b.  Assign four spaces to the tab key                     
          c.  Right, Left or Center Text                     
          d.  Left Align a Block Of Lines                                         
          e.  Comment a Block of SAS Code          
      ...
      II.  Javascript Tools          
         ...
         d.  Save program using path in line 2 of editor  (Ctrl + Alt + 2)  
             If a pop up with the highlighted code does not pop up then the program was not saved  
             Place javascript (also in this repository) also in this repo           
              
             Save jvascript in 
             C:\Program Files\IDM Computer Solutions\UltraEdit\scripts\save_program_in_line_2.js 
            ...
            Advamced > All Scripts > Add 
             
            Script: save_program_in_line_2 
            HotKey: Alt+Ctrl+2 
            OK 
             
            Put focus on editor and press Ctrl+Alt+2
            
            Make sure you have made changes to program,
            
            An output window will appear at the booton of UE with
            
            Scripting engine: Using SpiderMonkey              
            Running script: C:\Program Files\IDM Computer Solutions\UltraEdit\scripts\save_program_in_line_2.js      
      
      
        III. List of enhanced functionality (full cheat sheet) 
         
         a. Block moves, shared windows hotkeys and mouse actions 
         ...
         b. Ehanced Key Mapping  
            ...
            3  Ctrl+Alt-2       Save Program using line 2 of program (debug Advanced>Play Scripts>save_program_in_line_2 )
        ...
        c. Javascript and User tools
            ...
            2  Ctrl+Alt+X       Execute Selected text using Jenner CLI
            3  Ctrl+Alt+L       Clear log and list (may have a line of residual text?)
            4  Ctrl+Alt-2       Save Program using line 2 of program
            5  Ctrl+Alt-E       Multiple consecutive spaces to one space
      ...
      II. Javascript Tools          
        ...
        III. List of enhanced functionality (full cheat sheet) 
           ...
           b. Ehanced Key Mapping  
              1  Ctrl+Alt+X       Run Highlighted Code 
              2  Ctrl+Alt+J       Run entire program with Jenner Aalytics
              3  Ctrl+Alt-2       Save Program using line 2 of program
              4  Ctrl+A Space     Clear any window
              5  Ctrl+S           Save ( chapter II shows how to add versioning)  
              6  F12              save as
              7  Cltrl+F          Docked small persistent find box (very usefull)  
